 ...
 */
exports.app = {
    url: "https://app-dev.multicast-media.com" // TODO: Change to Acounting Dashboard Url 
};
...
exports.oauth = {
    facebook: {
        ...
        callbackURL: "https://auth-dev.multicast-media.com/oauth/facebook/callback",
        scope: [
            "public_profile",
            "email"
        ],
    ...
    twitter: {
        name: "twitter",
        callbackURL: "https://auth-dev.multicast-media.com/oauth/twitter/callback",
    ...
    google: {
        name: "google",
        passReqToCallback: true,
        callbackURL: "https://auth-dev.multicast-media.com/oauth/google/callback",
    ...
    linkedin: {
        ...
        passReqToCallback: true,
        callbackURL: "http://auth-dev.multicast-media.com/oauth/linkedin/callback",
        "scope": [
            "r_emailaddress",
            "r_basicprofile"
        ]
