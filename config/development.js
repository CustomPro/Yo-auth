...
exports.db = {
    ...
    mongoConnection: 'mongodb://localhost:27017/yo-auth-dev'
};
 ...
 */
exports.app = {
    url: "http://localhost:3030" // TODO: Change to Acounting Dashboard Url 
};
...
exports.oauth = {
    ...
    linkedin: {
        ...
        passReqToCallback: true,
        callbackURL: "http://localhost:3000/oauth/linkedin/callback",
        "scope": [
            "r_emailaddress",
            "r_basicprofile"
        ]
